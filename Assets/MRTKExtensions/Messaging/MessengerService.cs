...
namespace MRTKExtensions.Messaging
{
    ...
    public class MessengerService : BaseExtensionService, IMessengerService
    {
        public MessengerService(IMixedRealityServiceRegistrar registrar,
            string name = null, uint priority = DefaultPriority,
